...
exports.GENERATED_SDK_USAGE_EXAMPLE = exports.STRIPE_SDK_DESIGN_PLAN = void 0;
exports.generateStripeSDK = generateStripeSDK;
exports.showGeneratedCodeSamples = showGeneratedCodeSamples;
 ...
 */
exports.STRIPE_SDK_DESIGN_PLAN = {
    product: {
        name: "stripe",
        version: "1.0.0",
 ...
 */
function generateStripeSDK() {
    const generator = new code_generation_1.SDKCodeGenerator(exports.STRIPE_SDK_DESIGN_PLAN);
 ...
 */
function showGeneratedCodeSamples(files) {
    console.log("\n" + "=".repeat(80));
 ...
 */
exports.GENERATED_SDK_USAGE_EXAMPLE = `
// examples/basic.ts
...
function runExample() {
    ...
    console.log(exports.GENERATED_SDK_USAGE_EXAMPLE);
    console.log("\n" + "=".repeat(80));
